...
n = network(2)
n.train(data-training_data_mean, genders)

# See how it performs on data not in the training set:
print("Output for [177, 76] is", n.output(np.array([177, 76])-training_data_mean), "(it should be close to 0).")
print("Output for [162, 53] is", n.output(np.array([162, 53])-training_data_mean), "(it should be close to 1).")